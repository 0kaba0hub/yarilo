...
// sessions and clear its pins so users move off NOW. This is deliberately
// different from the wire BACKEND-FLUSH (handleBackendFlush), which DRAINS
// without kicking. The kick is origin-local

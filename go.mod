...
require (
	...
	github.com/emersion/go-imap/v2 v2.0.0-beta.8.0.20260619141951-d7c3431a71d3
...
replace github.com/emersion/go-imap/v2 => github.com/0kaba0hub/go-imap/v2 v2.0.0-beta.8.0.20260619141951-d7c3431a71d3
